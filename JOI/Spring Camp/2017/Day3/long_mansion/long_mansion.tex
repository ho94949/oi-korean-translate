\begin{problem}{긴 저택}
	...
	\begin{itemize}
		...
		\item 둘째 질문에서, JOI군은 3, 4번 방 밖에 방문할 수 없다. 1과 3이 붙어 있는 열쇠 밖에 얻을 수 없으므로, 2번 방에 들어가지 못한다.
		\item 셋째 질문에서, JOI군은 4번 방에서 5번 방으로 가기 위한 종류 4의 열쇠를 얻을 수가 없기 때문에, 5번 방에 들어가지 못한다.
		\item 넷째 질문에서, JOI군이 방을 5, 4, 3번 방 순서로 방문한다면, 4번 방에 도착할 수 있다.
	\end{itemize}
