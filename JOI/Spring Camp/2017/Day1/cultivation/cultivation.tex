...
3
	...
	이 예제에서, 이주 첫 연도에 다음 칸들에 JOI 풀이 심어져 있다.
	...
	새 행성의 밭. `0'이 쓰여 있는 칸은 이주 첫 연도에 JOI 풀이 심어져 있다.
	\end{center}
	
	만약에 처음 3년 동안 바람을 서쪽, 남쪽, 남쪽으로 불어가게 만들면, 모든 격자에는 3년 이후에는 JOI 풀이 심어져 있을 것이다. 다음 숫자는 각 격자에 JOI 풀이 심어진 연도를 의미한다. 이는 최솟값이다.
